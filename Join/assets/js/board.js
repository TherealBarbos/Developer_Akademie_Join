...
function updateHTML() {
    ...
    for (let index = 0; index < inProgress.length; index++) {
        ...
        document.getElementById('inProgress').innerHTML += generateInProgressCard(element);
    }
    ...
    for (let index = 0; index < awaitFeedback.length; index++) {
        ...
        document.getElementById('awaitFeedback').innerHTML += generateAwaitFeedbackCard(element);
    }
}
